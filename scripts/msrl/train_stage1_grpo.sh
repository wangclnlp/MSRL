...
MODEL=${MODEL:-output/msrl/stage1_sft}
MODEL_TYPE=${MODEL_TYPE:-internvl3_5}
DATASET=${DATASET:-data/stage1_rl.jsonl}
PLUGIN=${PLUGIN:-scripts/msrl/msrl_grpo_plugin.py}
OUTPUT_DIR=${OUTPUT_DIR:-output/msrl/stage1_grpo}
...
SYSTEM_PROMPT=${SYSTEM_PROMPT:-"You are a multimodal reward model. First reason in <think>...</think>, then output the final preference in <answer>...</answer>."}
...
swift rlhf \
    ...
    --reward_funcs msrl_accuracy_reward msrl_format_reward \
