...
MODEL=${MODEL:-output/msrl/stage2_cmkd_sft}
MODEL_TYPE=${MODEL_TYPE:-internvl3_5}
DATASET=${DATASET:-data/stage3_multimodal_rl.jsonl}
PLUGIN=${PLUGIN:-scripts/msrl/msrl_grpo_plugin.py}
OUTPUT_DIR=${OUTPUT_DIR:-output/msrl/stage3_multimodal_grpo}
...
SYSTEM_PROMPT=${SYSTEM_PROMPT:-"You are a multimodal reward model. Predict the task type in <type>...</type>, optionally summarize the visual input in <caption>...</caption>, then reason in <think>...</think>, and output the final preference in <answer>...</answer>."}
